...
public abstract class BaseActivity extends AutoLayoutActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        StatusBarUtils.initStatusBarColor(this, R.color.blue_deep);
    }
...
//        refreshViewHolder.setOriginalImage(R.mipmap.dm_logo);
//        refreshViewHolder.setUltimateColor(R.color.blue_deep);
        // 设置下拉刷新和上拉加载更多的风格
